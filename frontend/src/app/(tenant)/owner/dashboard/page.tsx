  ...
  const summaryCards = [
    {
      ...
      desc: "Member aktif di seluruh cabang",
    },
    {
      label: "Member Baru",
      ...
      desc: "Pendaftar bulan ini (semua cabang)",
    },
    {
    ...
    },
    {
      ...
      desc: "Pendapatan seluruh cabang bulan ini",
      isCurrency: true,
    },
    {
    ...
    <div className="space-y-6 font-figtree pb-10 bg-white p-5 rounded-xl border border-gray-500/20">
      ...
      <div>
        ...
        <p className="text-sm text-zinc-500">
          Ringkasan performa gym Anda secara keseluruhan (semua cabang).
        </p>
      </div>
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-zinc-900 mt-1 font-outfit leading-tight">
                    {card.value}
                  </h3>
                </div>
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-500/20 shadow-sm">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-lg font-semibold text-zinc-900">
            Pendapatan 6 Bulan Terakhir (Semua Cabang)
          </h2>
        </div>
