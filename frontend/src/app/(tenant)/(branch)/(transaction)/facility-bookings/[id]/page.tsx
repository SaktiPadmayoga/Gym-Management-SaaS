                ...
                <div className="font-figtree rounded-xl bg-white border px-6 py-4 border-zinc-200 shadow-sm min-h-[500px]">
                    <div className="breadcrumbs text-sm text-zinc-400 mb-4">
                        <ul>
                            <li>Management</li>
                            <li>
                                <Link href="/facility-bookings" className="hover:text-zinc-600">
                                    Booking Fasilitas
                                </Link>
                            </li>
                    ...
                    <div className="flex items-center justify-between bg-zinc-50 p-4 rounded-xl border border-zinc-100 mb-6 w-full">
                        <div>
                            <p className="text-xs text-zinc-500 font-medium uppercase mb-1">Status Pembayaran</p>
                            <p className={`text-sm font-bold uppercase ${bookingData.payment_status === "paid" ? "text-green-600" : "text-yellow-600"}`}>{bookingData.payment_status}</p>
                        </div>
