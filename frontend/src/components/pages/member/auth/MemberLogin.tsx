        ...
        <FormProvider {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-6">
                ...
                <div className="flex items-center justify-between mt-[-8px]">
                    ...
                    <Link href="/member/forgot-password" className="text-xs font-bold transition-colors hover:opacity-80" style={{ color: primaryColor }}>
                        Lupa kata sandi?
                    </Link>
                </div>
...
export default function MemberLogin() {
    ...
    // Hanya loading state saat auth belum siap
        ...
        <div className="min-h-screen bg-white flex font-sans overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-950 flex-col justify-between p-12 overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-sm font-semibold text-zinc-400 max-w-md leading-relaxed">Akses portal member Anda untuk memesan kelas, memantau riwayat latihan, dan mengelola paket keanggotaan Anda.</p>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-white">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-md">
                    <div className="mb-10">
                        ...
                        <h2 className="text-3xl sm:text-4xl font-black text-zinc-900 tracking-tighter uppercase mb-2">Selamat Datang</h2>
                        <p className="text-sm font-medium text-zinc-500">Silakan masuk menggunakan kredensial member Anda.</p>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-xs text-zinc-500">
                            ...
                            <Link href="/#pricing" className="font-bold hover:underline" style={{ color: primaryColor }}>
                                Daftar sekarang
                            </Link>
                        </p>
                    </div>
