...
export default function MemberMembership() {
    ...
    return (
        <div className="space-y-6 font-figtree pb-10 bg-white p-5 rounded-xl border border-gray-500/20">
            ...
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-zinc-900">My Membership</h1>
                <p className="text-sm text-zinc-500 mt-1">Pantau status berlangganan dan lakukan upgrade paket Anda di sini.</p>
            </div>
