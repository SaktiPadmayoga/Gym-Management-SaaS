        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-xl">
                <div className="p-4 border-b flex items-center justify-between">
                    <h3 className="font-bold text-lg">Request Jadwal PT</h3>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div>
                        <label className="block text-sm font-semibold mb-1.5">Pilih Pelatih</label>
                        <select 
                            required
                    ...
                    <div>
                        <label className="block text-sm font-semibold mb-1.5">Tanggal Sesi</label>
                        <input 
                            required
                            type="date"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-semibold mb-1.5">Jam Mulai</label>
                            <select 
                                required
                                className="w-full p-2.5 border rounded-xl text-sm"
                                value={startAt}
                        ...
                        <div>
                            <label className="block text-sm font-semibold mb-1.5">Jam Selesai</label>
                            <select 
                                required
                                className="w-full p-2.5 border rounded-xl text-sm"
                                value={endAt}
                    ...
                    {isLoadingSlots && <p className="text-xs text-amber-500">Memeriksa jadwal pelatih...</p>}

                    <div>
                        <label className="block text-sm font-semibold mb-1.5">Catatan (Opsional)</label>
                        <textarea 
                            className="w-full p-2.5 border rounded-xl text-sm h-20 resize-none"
                    ...
                    <div className="pt-4 flex gap-3">
                        <button 
                            type="button" 
                            onClick={onClose}
                            className="flex-1 py-2.5 bg-zinc-100 hover:bg-zinc-200 text-zinc-700 rounded-xl font-bold text-sm"
                        >
                            Batal
                        </button>
                        <button 
                            ...
                            className="flex-1 py-2.5 bg-black hover:bg-zinc-800 text-white rounded-xl font-bold text-sm disabled:opacity-50"
                        >
