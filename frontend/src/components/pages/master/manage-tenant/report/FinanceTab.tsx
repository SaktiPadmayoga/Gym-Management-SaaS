...
import { DollarSign, CreditCard, Activity, TrendingUp, Star, BarChart2 } from "lucide-react";
        ...
        <div className="space-y-6 mt-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-500/20">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-sm font-medium text-zinc-500 font-atkin tracking-tighter">SaaS MRR</p>
                            <h3 className="text-2xl font-bold text-zinc-900 mt-1 font-outfit">{formatRupiah(mrr)}</h3>
                            <p className="text-xs text-zinc-400 mt-1 font-atkin tracking-tighter">Recurring Bulanan</p>
                        </div>
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-500/20">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-sm font-medium text-zinc-500 font-atkin tracking-tighter">SaaS ARR</p>
                            <h3 className="text-2xl font-bold text-zinc-900 mt-1 font-outfit">{formatRupiah(arr)}</h3>
                            <p className="text-xs text-zinc-400 mt-1 font-atkin tracking-tighter">MRR × 12</p>
                        </div>
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-500/20">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <p className="text-xs text-zinc-400 mt-1 font-atkin tracking-tighter font-mono">AOV</p>
                        </div>
