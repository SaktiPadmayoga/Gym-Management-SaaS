...
import { Dumbbell, Eye, EyeOff, Save } from "lucide-react";
                ...
                >
                    ...
                    <div className="mb-10 text-center flex flex-col items-center">
                        ...
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-2">
                            Untuk akun <span className="text-slate-600">{email}</span>
                        </p>
                    </div>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-6">
                            ...
                            <div className="relative group">
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-[32px] p-1.5 text-slate-400 hover:text-teal-600 transition-colors bg-white rounded-md"
                                    tabIndex={-1}
                                >
