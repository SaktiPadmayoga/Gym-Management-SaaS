                    ...
                    <div className="flex items-center gap-3 text-gray-800">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                <span className={`text-xs px-2 py-0.5 rounded-md border font-medium capitalize ${getTypeColor(domain.type)}`}>{domain.type}</span>
                                {domain.is_primary && <span className="text-xs px-2 py-0.5 rounded-md border font-medium text-yellow-700 bg-yellow-50 border-yellow-200">Primary</span>}
                            </div>
                        </div>
                    </div>

                    <div className="flex items-center gap-2">
                        {/* <CustomButton type="button" className=" text-white hover:bg-blue-50 px-4 py-2.5" onClick={() => router.push(`/admin/domains/${id}/edit`)}>
                            Edit
                        </CustomButton> */}
                        <CustomButton type="button" className="bg-red-500 text-white hover:bg-red-600 border-none px-4 py-2.5" onClick={handleDelete} disabled={deleteMutation.isPending}>
                ...
                <div className="mt-6 grid grid-cols-12 gap-4">
                    ...
                    <div className="col-span-6">
                        <div className="rounded-xl border border-zinc-100 bg-zinc-50/50 p-5">
                            <h3 className="text-sm font-semibold text-zinc-500 uppercase tracking-wide mb-4">Domain Information</h3>
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-center py-2 border-b border-zinc-100">
                                    ...
                                    <span className={`text-xs px-2 py-1 rounded-md border font-medium capitalize ${getTypeColor(domain.type)}`}>{domain.type}</span>
                                </div>
                                <div className="flex justify-between items-center py-2">
                                    <span className="text-sm text-zinc-500">Primary</span>
                                    <span className={`text-sm font-medium ${domain.is_primary ? "text-green-600" : "text-zinc-400"}`}>{domain.is_primary ? "Yes" : "No"}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-span-6">
                        <div className="rounded-xl border border-zinc-100 bg-zinc-50/50 p-5">
                            <h3 className="text-sm font-semibold text-zinc-500 uppercase tracking-wide mb-4">Associations</h3>
                            <div className="space-y-3">
                                <div className="flex justify-between items-center py-2 border-b border-zinc-100">
                                    ...
                                    <div className="text-right">
                                        ...
                                        {domain.tenant?.slug && <div className="text-xs text-zinc-400">{domain.tenant.slug}</div>}
                                    </div>
                                </div>
                                <div className="flex justify-between items-center py-2">
                                    ...
                                    <div className="text-right">
                                        ...
                                        {domain.branch?.branch_code && <div className="text-xs text-zinc-400">{domain.branch.branch_code}</div>}
                                    </div>
                                </div>
                            </div>
                        </div>
