...
import { Building2, Eye, EyeOff, Save, Activity } from "lucide-react";
        ...
        <div className="min-h-screen bg-white flex font-sans overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-950 flex-col justify-between p-12 overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-sm font-semibold text-zinc-400 max-w-md leading-relaxed">Buat kata sandi baru yang aman untuk melindungi akun portal staf Anda.</p>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-md">
                    <div className="mb-10">
                        ...
                        <p className="text-sm font-medium text-zinc-500">
                            Untuk akun staf <span className="font-bold text-zinc-700">{email}</span>
                        </p>
                    </div>
