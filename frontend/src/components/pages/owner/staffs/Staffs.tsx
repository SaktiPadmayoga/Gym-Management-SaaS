            ...
            render: (item) => (
                <span
                    className={`rounded-lg px-2 py-1 text-sm font-medium ${
                        globalRoleColor[item.role] ?? "bg-zinc-100 text-zinc-600"
                    }`}
                >
                    {item.role}
                </span>
        ...
        },
        {
            ...
            render: (item) => {
                ...
                if (branches.length === 0)
                    return <span className="text-zinc-400 text-sm">No branch</span>;
                        ...
                        {branches.slice(0, 2).map((sb) => (
                            <span
                                ...
                                className={`rounded-md px-2 py-0.5 text-xs font-medium ${
                                    branchRoleColor[sb.role] ?? "bg-zinc-100 text-zinc-600"
                                }`}
                            >
            ...
            <div>
                <div className="rounded-xl font-figtree bg-white border border-gray-500/20 px-6 py-4">
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-semibold text-zinc-800">Staff</h1>
                            <p className="text-zinc-500">Manage staff accounts and branch access</p>
                        </div>
