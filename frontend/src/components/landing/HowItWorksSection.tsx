...
const steps = [
    {
        ...
        description: "Input data member, staf, dan paket dari sistem manual Anda. Setup database GYMFIT selesai secara otomatis tanpa hambatan.",
    },
    {
        number: "02",
        icon: <Settings2 className="w-6 h-6" />,
        title: "Konfigurasi Sistem",
        description: "Konfigurasi role, jadwal kelas, dan plan member. Sesuaikan alur dengan SOP operasional gym Anda.",
    },
    {
        number: "03",
...
const HowItWorksSection = () => {
    return (
        <section id="how-it-works" className="relative py-24 md:py-24 px-6 bg-white overflow-hidden font-sans max-w-7xl mx-auto">
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <motion.div
                    ...
                    className="mb-16 md:mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8 md:gap-6"
                >
                    <div>
                    ...
                    <div className="max-w-xs">
                        <p className="text-sm font-bold text-slate-500 uppercase tracking-tight leading-relaxed">Transisi mulus tanpa downtime. Tidak perlu tim IT khusus untuk mulai mengelola cabang Anda.</p>
                    </div>
                </motion.div>

                {/* --- STEPS PIPELINE --- */}
                <div className="relative grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-3">
                    ...
                    <div className="hidden md:block absolute top-16 left-[15%] right-[15%] h-[2px] bg-slate-100 z-0">
                        <motion.div initial={{ width: 0 }} whileInView={{ width: "100%" }} viewport={{ once: true }} transition={{ duration: 1.5, delay: 0.5, ease: "easeInOut" }} className="h-full bg-teal-500/30" />
                    </div>
                    ...
                    {steps.map((step, i) => (
                        <motion.div
                            ...
                            className="relative z-10 bg-slate-50 border border-slate-200 rounded-[2.5rem] lg:rounded-[2rem] p-8 md:p-8 hover:bg-white transition-all duration-500 group shadow-sm hover:shadow-xl hover:shadow-slate-200/50 overflow-hidden"
                        >
                            ...
                            <div className="relative z-10 flex items-center justify-between mb-10">
                                ...
                                {i < steps.length - 1 && <ArrowRight className="text-slate-300 md:hidden" />}
                            </div>
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tighter mb-3 leading-none">{step.title}</h3>
