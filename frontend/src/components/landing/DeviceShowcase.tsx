...
const DeviceShowcase = () => {
    return (
        <section className="relative font-sans flex flex-col w-full">
            ...
            {/* ========================================== */}
            <div className="bg-white py-24 lg:py-20 px-6 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-6 items-center">
                    ...
                    <div className="relative h-[400px] md:h-[500px] flex items-center justify-center">
                        ...
                        <motion.div
                            ...
                            className="absolute left-0 md:left-10 w-[85%] aspect-[4/3] bg-slate-50 border-[10px] border-slate-900 rounded-[2rem] lg:rounded-[1.5rem] shadow-2xl overflow-hidden flex flex-col"
                        >
                            {/* Tablet Header */}
                        ...
                        <motion.div
                            ...
                            className="absolute right-0 md:right-10 bottom-0 w-[140px] md:w-[180px] aspect-[1/2.1] bg-white border-[8px] border-slate-900 rounded-[2rem] lg:rounded-[1.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col"
                        >
                            {/* iPhone Notch */}
                    ...
                    <div className="max-w-lg lg:ml-auto">
                        <motion.h2
                            ...
                            className="text-4xl md:text-4xl font-black tracking-tighter leading-tight text-slate-900 mb-6"
                        >
                            Keuntungan Maksimal Dengan <span className="text-teal-500">Operasional Optimal.</span>
                        </motion.h2>
                        <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }} className="text-slate-500 leading-relaxed font-medium mb-8">
                            Pantau performa bisnis gym Anda dari mana saja. GYMFIT memberikan pengalaman penggunaan yang intuitif untuk staf di lapangan dan dashboard analitik lengkap untuk manajemen di level strategis.
                        </motion.p>
            ...
            {/* ========================================== */}
            <div className="bg-teal-600 pt-20 lg:pt-16 pb-0 px-6 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-8 items-start lg:items-center">
                    {/* KIRI: Teks Konten */}
                    <div className="max-w-lg pb-16 lg:pb-20">
                        <motion.p
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            transition={{ duration: 0.6 }}
                            className="text-white/90 text-lg md:text-lg leading-relaxed font-medium mb-6 text-justify "
                        >
                        ...
                        <motion.p
                            ...
                            className="text-white/80 text-base md:text-base leading-relaxed text-justify"
                        >
                            Pantau arus kas, kelola absensi kelas, dan jalankan pengelolaan keuangan secara efisien, sehingga Anda bisa fokus mengembangkan bisnis, bukan urusan administrasi.
                        </motion.p>
                    </div>

                    {/* KANAN: Desktop Mockup (Menempel di bawah) */}
                    <div className="relative h-[300px] lg:h-[400px] w-full flex items-end justify-center lg:justify-end ">
                        <motion.div
                            initial={{ opacity: 0, y: 100 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true, margin: "-50px" }}
                            transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
                            className="absolute bottom-[-10px] w-[110%] lg:w-[120%] lg:-right-10 aspect-video bg-slate-900 rounded-t-[2rem] lg:rounded-t-[1.5rem] border-[12px] border-slate-900 border-b-0 shadow-[0_-20px_60px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col "
                        >
                            {/* Browser Header */}
