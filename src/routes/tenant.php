...
Route::middleware(['auth:staff', 'check_tenant_access', 'check_branch_access'])->group(function () {
    ...
    // Check-ins
    Route::middleware('permission:check_ins')->group(function () {
...
Route::middleware(['auth:staff', 'check_tenant_access', 'check_branch_access'])->group(function () {
    ...
    Route::middleware('permission:pt_sessions')->group(function () {
    ...
    Route::post('/tenant/landing-image', [TenantController::class, 'uploadLandingImage']);
